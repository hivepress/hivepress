...
if ( isset( $after_registration ) ) :?>
<p><?php esc_html_e( 'Thank you for registration! Please check your email to activate your account. If you have not received email then please fill in the form below to resend the verification email.', 'hivepress' ); ?></p>
<?php else : ?>
