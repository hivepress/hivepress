		...
		<div class="plugin-card">
			...
			<div class="plugin-card-bottom">
				...
				<div class="column-compatibility">
					...
					<span class="compatibility-compatible"><?php echo hp\sanitize_html( __( '<strong>Compatible</strong> with your version of WordPress', 'hivepress' ) ); ?></span>
					<?php else : ?>
					<span class="compatibility-incompatible"><?php echo hp\sanitize_html( __( '<strong>Incompatible</strong> with your version of WordPress', 'hivepress' ) ); ?></span>
					<?php endif; ?>
				</div>
			</div>
		</div>
