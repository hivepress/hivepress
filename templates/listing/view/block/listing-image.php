...
?>
<div class="hp-listing__image" data-component="carousel-slider" data-preview="false" data-aspect-ratio="<?php echo esc_attr( hivepress()->asset->get_aspect_ratio( 'landscape_small' ) ); ?>" data-url="<?php echo esc_url( hivepress()->router->get_url( 'listing_view_page', [ 'listing_id' => $listing->get_id() ] ) ); ?>">
	<?php
	if ( get_option( 'hp_listing_enable_image_preview' ) && $image_count > 1 ) :
		...
		<a href="<?php echo esc_url( hivepress()->router->get_url( 'listing_view_page', [ 'listing_id' => $listing->get_id() ] ) ); ?>">
			...
			<?php else : ?>
				<img src="<?php echo esc_url( hivepress()->asset->get_image_url( get_option( 'hp_listing_placeholder_image' ), 'hp_landscape_small', hivepress()->get_url() . '/assets/images/placeholders/image-landscape.svg' ) ); ?>" alt="<?php echo esc_attr( $listing->get_title() ); ?>" loading="lazy">
			<?php endif; ?>
		</a>
	<?php endif; ?>
</div>
