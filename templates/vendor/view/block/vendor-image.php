...
<div class="hp-vendor__image">
	<a href="<?php echo esc_url( hivepress()->router->get_url( 'vendor_view_page', [ 'vendor_id' => $vendor->get_id() ] ) ); ?>">
		...
		<?php else : ?>
			<img src="<?php echo esc_url( hivepress()->asset->get_image_url( get_option( 'hp_vendor_placeholder_image' ), 'hp_square_small', hivepress()->get_url() . '/assets/images/placeholders/user-square.svg' ) ); ?>" alt="<?php echo esc_attr( $vendor->get_name() ); ?>" loading="lazy">
		<?php endif; ?>
	</a>
</div>
