...
return [
	...
	'click_to_copy'                             => esc_html__( 'Click to copy', 'hivepress' ),
	...
	'placeholder_image'                         => esc_html__( 'Placeholder Image', 'hivepress' ),
	'select_image'                              => esc_html__( 'Select Image', 'hivepress' ),
	'select_images'                             => esc_html__( 'Select Images', 'hivepress' ),
	'select_image_to_display_if_no_image'       => esc_html__( 'Select an image to display when no image is uploaded.', 'hivepress' ),
	...
	'expires_on'                                => esc_html__( 'Expires on %s', 'hivepress' ),
	'expired_on'                                => esc_html__( 'Expired on %s', 'hivepress' ),
	'no_expiration'                             => esc_html__( 'No expiration', 'hivepress' ),
	...
	'delete'                                    => esc_html__( 'Delete', 'hivepress' ),
